...
public class CombinedCommands {
     ...
     * @return
     */
    public SequentialCommandGroup scoreInSpeakerSequentialGroup(Shooter shooter, IntakeSubsystem intake) {
      return shooter
     ...
     * @return
     */
    public SequentialCommandGroup loadNoteForAmp(Shooter shooter, IntakeSubsystem intake) {
      return Commands
     ...
     * @return
     */
    public SequentialCommandGroup stopShooterAndIntakeCommand(Shooter shooter, IntakeSubsystem intake) {
     ...
     * @return
     */
    public Map<String, Command> getNamedCommands(Shooter shooter, IntakeSubsystem intake) {
      return Map.of(
        "Score_In_Speaker",
